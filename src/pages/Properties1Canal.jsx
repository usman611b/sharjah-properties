...
const Properties1Canal = () => {
  ...
  // Fetch 1 Canal properties
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        setLoading(true)
        const data = await propertyService.get1CanalProperties()
        setProperties(data)
      } catch (error) {
        console.error('Error fetching 1 Canal properties:', error)
        setProperties([])
      } finally {
        setLoading(false)
      }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-lg text-gray-600">Loading 1 Canal properties...</div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white shadow-sm">
        <div className="container-custom py-16">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">1 Canal Properties</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience ultimate luxury with our exclusive 1 Canal (25 Marla) properties.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">Showing 1 Canal properties</p>
            </div>
...
export default Properties1Canal 