...
const Properties10Marla = () => {
  ...
  // Fetch 10 Marla properties
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        setLoading(true)
        const data = await propertyService.get10MarlaProperties()
        setProperties(data)
      } catch (error) {
        console.error('Error fetching 10 Marla properties:', error)
        setProperties([])
      } finally {
        setLoading(false)
      }
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-lg text-gray-600">Loading 10 Marla properties...</div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white shadow-sm">
        <div className="container-custom py-16">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">10 Marla Properties</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover luxurious 10 Marla properties offering spacious living and premium amenities.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">Showing 10 Marla properties</p>
            </div>
...
export default Properties10Marla 